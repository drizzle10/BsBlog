...
<header>
  ...
  <c:choose>
  	...
  	<c:when test="${sessionScope.sId eq 'admin' }">
	 	 <div id="login"><a href="admin.me=member_id?${sessionScope.sId }">${sessionScope.sId }님</a> | <a href="javascript:logout()">Logout</a></div> 
  	</c:when>
	 <c:otherwise>
  		 <div id="login"><a href="memberInfo.me=member_id?${sessionScope.sId }">${sessionScope.sId }님</a> | <a href="javascript:logout()">Logout</a></div>
	 </c:otherwise>
  </c:choose>
  <div class="clear"></div>
  <!-- 로고들어가는 곳 -->
